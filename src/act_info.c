...
const char *const where_name[] = {
   " &G&c[&wused as light    &c]&G&w ",
   " &G&c[&wworn on finger   &c]&G&w ",
   " &G&c[&wworn on finger   &c]&G&w ",
   " &G&c[&wworn around neck &c]&G&w ",
   " &G&c[&wworn around neck &c]&G&w ",
   " &G&c[&wworn on body     &c]&G&w ",
   " &G&c[&wworn on head     &c]&G&w ",
   " &G&c[&wworn on legs     &c]&G&w ",
   " &G&c[&wworn on feet     &c]&G&w ",
   " &G&c[&wworn on hands    &c]&G&w ",
   " &G&c[&wworn on arms     &c]&G&w ",
   " &G&c[&wenergy shield    &c]&G&w ",
   " &G&c[&wworn about body  &c]&G&w ",
   " &G&c[&wworn about waist &c]&G&w ",
   " &G&c[&wworn around wrist&c]&G&w ",
   " &G&c[&wworn around wrist&c]&G&w ",
   " &G&c[&wwielded          &c]&G&w ",
   " &G&c[&wheld             &c]&G&w ",
   " &G&c[&wdual wielded     &c]&G&w ",
   " &G&c[&wworn on ears     &c]&G&w ",
   " &G&c[&wworn on eyes     &c]&G&w ",
   " &G&c[&wmissile wielded  &c]&G&w ",
   " &G&c[&wworn on back     &c]&G&w ",
   " &G&c[&wleft holster     &c]&G&w ",
   " &G&c[&wright holster    &c]&G&w ",
   " &G&c[&wworn both wrists &c]&G&w ",
   " &G&c[&wcyber eyes       &c]&G&w ",
   " &G&c[&wcyber brain      &c]&G&w ",
   " &G&c[&wcyber arms       &c]&G&w ",
   " &G&c[&wcyber legs       &c]&G&w ",
   " &G&c[&wcyber body       &c]&G&w ",
   " &G&c[&wcyber epidermis  &c]&G&w "
};
...
*/
      ...
      switch ( wch->top_level )
      {
         ...
         case 200:
            ...
            break;
         case MAX_LEVEL - 0:
            race = "&G&z(&G&w    Admin    &G&z)&G&w";
            break;
         case MAX_LEVEL - 1:
            race = "&G&z(&G&wHead Immortal&G&z)&G&w";
            break;
         case MAX_LEVEL - 2:
            race = "&G&z(&G&wHigh Builder &G&z)&G&w";
            break;
         case MAX_LEVEL - 3:
            race = "&G&z(&G&w   Builder   &G&z)&G&w";
            break;
         case MAX_LEVEL - 4:
            race = "&G&z(&G&w Apprentice  &G&z)&G&w";
            break;
         case MAX_LEVEL - 5:
            race = "&G&z(&G&w   Retired   &G&z)&G&w";
            break;
      }
   ...
   if( first_newbie )
   {
      if( !ch )
         fprintf( whoout, "%s",
                  htmlcolor
                  ( "&G===&B[&PSynMUD&B]&G===&B[ &WMortals &B]&G=====================================================&B[]&W\n\n" ) );
      else
         send_to_pager
            ( "\r\n&G===&B[&PSynMUD&B]&G===&B[ &WMortals &B]&G=====================================================&B[]&W\r\n\r\n",
              ch );
   ...
   if( !ch )
   {
      fprintf( whoout,
               htmlcolor
               ( "&z=====================( &C%d &cvisible &zplayer%s. &C%d &ctotal&z player%s. )=====================\n" ),
