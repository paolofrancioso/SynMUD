...
void do_inquire( CHAR_DATA * ch, const char *argument )
{
   ...
   xpgain = 3000;
   gain_exp( ch, xpgain, HACKER_ABILITY );
...
void do_makecommsystem( CHAR_DATA * ch, const char *argument )
{
...

   {
      ...
      xpgain =
         UMIN( obj->cost * 10,
               ( exp_level( ch->skill_level[HACKER_ABILITY] + 1 ) - exp_level( ch->skill_level[HACKER_ABILITY] ) ) );
      gain_exp( ch, xpgain, HACKER_ABILITY );
...
void do_codecrack( CHAR_DATA * ch, const char *argument )
{
   ...
   }
   {
      ...
      ch_printf( ch, "&B[+-----+-----+-----+-----+-----+-----+-----+-----+-]&W\r\n" );
      //xpgain = UMIN( obj->cost*10 ,( exp_level(ch->skill_level[HACKER_ABILITY]+1) - exp_level(ch->skill_level[HACKER_ABILITY]) ) );
      xpgain = 3000;
      ch->pcdata->is_hacking = FALSE;
      gain_exp( ch, xpgain, HACKER_ABILITY );
