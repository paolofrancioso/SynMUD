...
#define COMMANDO_ABILITY 	0
#define DEFENDER_ABILITY	1
#define ENGINEER_ABILITY	2
#define HUNTER_ABILITY		3
#define INFILTRATOR_ABILITY	4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
#define PERSUADER_ABILITY	5
#define FORCE_ABILITY		6 //Not Used 
#define HACKER_ABILITY		7
#define	ASSASSIN_ABILITY	8
#define	MEDIC_ABILITY		9


/* the races */
#define RACE_ITALIAN	    0
#define RACE_GERMAN			1
#define RACE_FRENCH			2
#define RACE_SPANISH		3
#define RACE_ENGLISH		4
#define RACE_RUSSIAN		5
#define RACE_CHINESE		6
#define RACE_JAPANESE		7
#define RACE_TURKISH		8
#define RACE_AMERICAN       9
#define RACE_INDIAN        10
#define RACE_AUSTRALIAN    11
#define RACE_BRAZILIAN     12
#define RACE_MEXICAN       13
#define RACE_AFRICAN       14
#define RACE_DROID         15
#define RACE_ANDROID       16
#define RACE_CYBORG        17

/*
 * Languages -- Altrag
 */
#define LANG_BASIC      BV00  /* Human base language */
#define LANG_ITALIAN     BV01
#define LANG_GERMAN     BV02
#define LANG_FRENCH      BV03
#define LANG_SPANISH        BV04
#define LANG_ENGLISH   BV05
#define LANG_RUSSIAN      BV06
#define LANG_CHINESE        BV07
#define LANG_JAPANESE    BV08
#define LANG_TURKISH       BV09
#define LANG_INDIAN  BV10
#define LANG_PORTUGUESE      BV11
#define LANG_AFRO   BV12
#define LANG_BINARY        BV13
#define LANG_CLAN        BV14
#define LANG_UNKNOWN        0 /* Anything that doesnt fit a category */
#define VALID_LANGS    ( LANG_BASIC | LANG_ITALIAN | LANG_GERMAN | LANG_FRENCH  \
		       | LANG_SPANISH | LANG_ENGLISH | LANG_RUSSIAN | LANG_CHINESE \
		       | LANG_JAPANESE | LANG_TURKISH | LANG_INDIAN | LANG_PORTUGUESE | LANG_AFRO \
		       | LANG_BINARY | LANG_CLAN | LANG_UNKNOWN )
/*  32 Languages */
...
#define OBJ_VNUM_UTOPIA_CHIP	  156
...
typedef enum
{
   ...
   ITEM_CYBER_EYE, ITEM_CYBER_BRAIN, ITEM_CYBER_ARMS, ITEM_CYBER_LEGS, ITEM_CYBER_BODY, ITEM_CYBER_EPIDERMIS
} item_types;


#define MAX_ITEM_TYPE		     ITEM_CYBER_EPIDERMIS
/*
 * Extra flags.
 * Used in #OBJECTS.
 */
...
//Cyberware
#define	ITEM_WEAR_CYBER_EYE			BV23
#define	ITEM_WEAR_CYBER_BRAIN		BV24
#define	ITEM_WEAR_CYBER_ARMS		BV25
#define	ITEM_WEAR_CYBER_LEGS		BV26
#define	ITEM_WEAR_CYBER_BODY		BV27
#define	ITEM_WEAR_CYBER_EPIDERMIS	BV28
...
typedef enum
{
   ...
   WEAR_CYBER_EYE, WEAR_CYBER_BRAIN, WEAR_CYBER_ARMS, WEAR_CYBER_LEGS,
   WEAR_CYBER_BODY, WEAR_CYBER_EPIDERMIS,
   MAX_WEAR
} wear_locations;
...
extern short gsn_makedeflshield;
...
extern short gsn_deflectingshields;
...
extern short gsn_italian;
extern short gsn_german;
extern short gsn_french;
extern short gsn_spanish;
extern short gsn_english;
extern short gsn_russian;
extern short gsn_chinese;
extern short gsn_japanese;
extern short gsn_turkish;
extern short gsn_indian;
extern short gsn_portuguese;
extern short gsn_afro;
...
#define IS_DROID(ch)		(ch->race == RACE_DROID || ch->race == RACE_ANDROID || ch->race == RACE_CYBORG)
...
#define GET_AC(ch)		( (ch)->armor + ( IS_AWAKE(ch) ? dex_app[get_curr_dex(ch)].defensive : 0 ) \
				         -  (ch)->skill_level[DEFENDER_ABILITY] / 10 )
...
DECLARE_DO_FUN( do_makedeflshield );
...
//Fake Star System - Government New System
DECLARE_DO_FUN( do_regions );
DECLARE_DO_FUN( do_makeregion );
DECLARE_DO_FUN( do_setregion );
