...
void boot_db( bool fCopyOver )
{
    ...
    */
   {
      ...
      ASSIGN_GSN( gsn_italian, "italian" );
      ASSIGN_GSN( gsn_german, "german" );
      ASSIGN_GSN( gsn_french, "french" );
      ASSIGN_GSN( gsn_spanish, "spanish" );
	  ASSIGN_GSN( gsn_english, "english" );
      ASSIGN_GSN( gsn_russian, "russian" );
      ASSIGN_GSN( gsn_chinese, "chinese" );
      ASSIGN_GSN( gsn_japanese, "japanese" );
      ASSIGN_GSN( gsn_turkish, "turkish" );
      ASSIGN_GSN( gsn_indian, "indian" );
      ASSIGN_GSN( gsn_portuguese, "portuguese" );
      ASSIGN_GSN( gsn_afro, "afro" );
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA * pMobIndex )
{
   ...
   if( pMobIndex->ac )
      ...
      mob->armor = ( short )10 - mob->top_level / 1.5;
...
void make_wizlist(  )
{
   ...
   towizfile( "&C         | |                                                          | &C|", 0 );
   towizfile( "&C       \\ \\________________________________________________________/ /", 0 );
   towizfile( "&C       \\__________________________________________________________/", 0 );
   towizfile( "                                                                           ", 0 );
}
      ...
      switch ( word[0] )
      {
         ...
         case 'R':
            if( !str_cmp( word, "Race" ) )
            {
               ...
               {
                  bug( "%s: vnum %d: Mob has invalid race! Defaulting to English.", __FUNCTION__, pMobIndex->vnum );
                  race = get_npc_race( "english" );
               }
