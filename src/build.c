...
/* Fake startsystem/regions implementation. Fill planetflags as zones flags */
...
const char *const w_flags[] = {
   ...
   "r25", "cyber_eye", "cyber_brain", "cyber_arms", "cyber_legs", "cyber_body", "cyber_epidermis"
};
...
const char *const o_types[] = {
   ...
   "binders", "goggles", "shipbomb", "empgrenade", "cyber_eye", "cyber_brain", "cyber_arms", 
   "cyber_legs", "cyber_body", "cyber_epidermis"
};
...
const char *const act_flags[] = {
   ...
   "r28", "cybersurgeon", "prototype", "r31"
};
...
const char *const wear_locs[] = {
   ...
   "holster1", "holster2", "bothwrists", "cyber_eye", "cyber_brain", "cyber_arms", 
   "cyber_legs", "cyber_body", "cyber_epidermis"
};
...
*/
   if( arg1[0] == '\0' || ( arg2[0] == '\0' && ch->substate != SUB_REPEATCMD ) || !str_cmp( arg1, "?" ) )
   {
      ...
      send_to_char( "  credits hp shieldpoints move align race\r\n", ch );
...
/* Player msetting restriction added by Tawnos */
   ...
   if( !str_cmp( arg2, "armor" ) )
   {
      ...
      {
         send_to_char( "AC range is -20 to 20.\r\n", ch );
         return;
      }
      victim->armor = value;
      if( IS_NPC( victim ) && IS_SET( victim->act, ACT_PROTOTYPE ) )
   ...
   if( !str_cmp( arg2, "shieldpoints" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 0 || value > 30000 )
      {
         send_to_char( "Shieldpoints range is 1 to 30000 sp.\r\n", ch );
         return;
      }
